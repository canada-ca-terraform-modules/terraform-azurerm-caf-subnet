...
resource azurerm_subnet subnet {
  ...
  enforce_private_link_service_network_policies  = lookup(var.subnet, "enforce_private_link_service_network_policies", false)
  enforce_private_link_endpoint_network_policies = lookup(var.subnet, "enforce_private_link_endpoint_network_policies", false)
